...
|---|---|---|---|---|
| `ucum:` | UCUM — Unified Code for Units of Measure | expression | 204 mapped + 41 arbitrary, **all 312 UCUM defines** | [2](#2-syntax)–[10](#10-cost-risk-and-what-is-left-out) |
...
| `om:` | OM 2 — Ontology of units of Measure | flat | 1335 + 125 refused, **every unit individual OM states** | [16](#16-the-om-2-profile) |
...
The shipped table is `src/gendata/ucum.bvnr`: 204 mapped **atoms**, 41 arbitrary units, 67 known
...
do not. **Osmolality** and the **mean Gregorian month** are the ones still waiting.
...
| `om.bvnr` | 1335 mapped, 125 unsupported |
...
> Data file `src/gendata/om.bvnr` (1335 mapped, 125 refused — every unit individual OM states);
