...
│                       bvnr_conformance                            │
│                                                                   │
│  Test corpus (347 cases) ──→ for each test case:                │
│                                                                   │
...
| `units` | 53 | SI/IEC prefixes, compact prefix form, compound, inline, errors |
...
parent plan therefore counts the groups (currently 22), not the 347 cases.
