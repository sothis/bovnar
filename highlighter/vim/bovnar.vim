...
hi BovnarType         ctermfg=228 guifg=#f0c64e gui=bold
...
hi BovnarFloat        ctermfg=39  guifg=#67d1f4 gui=none
hi BovnarInteger      ctermfg=39  guifg=#67d1f4 gui=none
...
hi BovnarUnitExp      ctermfg=209 guifg=#da844c gui=none
hi BovnarTypeUnit     ctermfg=80  guifg=#5eead4 gui=none
hi BovnarTypeUnitSep  ctermfg=66  guifg=#6e7a86 gui=none
hi BovnarTypeUnitExp  ctermfg=209 guifg=#da844c gui=none
...
syn region  BovnarTypeAnn
      ...
      \          BovnarFloat,BovnarInteger,BovnarString,
...
syn match   BovnarUnitPrefix '[A-Za-z][A-Za-z0-9]*\~[A-Za-z0-9_·\-\+\/*\^]*'
...
syn match   BovnarTypeParam '[0-9]\+' contained
syn match   BovnarTypeParam 'q[0-9]\+' contained
syn match   BovnarTypeParam '_[0-9]\+' contained
...
syn match   BovnarTypePrefix  '[A-Za-z][A-Za-z0-9]*\~' contained
