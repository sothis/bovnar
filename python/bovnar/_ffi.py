...
def _declare_functions(lib: ctypes.CDLL) -> None:
    ...
    lib.bvn_parse_double.argtypes = [
        c_char_p,
        ValueTypeSpec,
        ctypes.POINTER(c_double),
    ]

    lib.bvn_format_uint64.restype  = ctypes.c_int32
    lib.bvn_format_uint64.argtypes = [
        c_char_p, c_size_t, ctypes.c_uint64, c_uint32, c_uint32,
    ]

    lib.bvn_format_int64.restype  = ctypes.c_int32
    lib.bvn_format_int64.argtypes = [
        c_char_p, c_size_t, ctypes.c_int64, c_uint32, c_uint32,
    ]

    lib.bvn_format_double.restype  = ctypes.c_int32
    lib.bvn_format_double.argtypes = [
        c_char_p, c_size_t, c_double, ValueTypeSpec,
    ]

    lib.bvn_parse_unit.restype  = ValueUnit
    lib.bvn_parse_unit.argtypes = [c_uint8_p, ctypes.POINTER(c_bool)]

    lib.bvn_parse_unit_n.restype  = ValueUnit
    lib.bvn_parse_unit_n.argtypes = [c_uint8_p, c_uint32, ctypes.POINTER(c_bool)]

    lib.bvn_unit_to_string.restype  = ctypes.c_int32
    lib.bvn_unit_to_string.argtypes = [ValueUnit, c_char_p, c_size_t]

    lib.bvn_unit_to_string_ex.restype  = ctypes.c_int32
    ...
    lib.bvn_unit_prefix_exponent.restype  = ctypes.c_int32
    ...
    lib.bvn_unit_dimension_vector.argtypes = [
        ValueUnit,
        ctypes.POINTER(ctypes.c_int32),
    ]

    lib.bvn_unit_reduce.restype  = ValueUnit
    lib.bvn_unit_reduce.argtypes = [
        ValueUnit,
        ctypes.POINTER(c_double),
        ctypes.POINTER(c_bool),
    ]

    lib.bvn_exponent_to_int.restype  = ctypes.c_int32
    lib.bvn_exponent_to_int.argtypes = [ctypes.c_int]

    lib.bvn_prefix_unit_valid.restype  = c_bool
    lib.bvn_prefix_unit_valid.argtypes = [ValueUnit, ctypes.c_int]
