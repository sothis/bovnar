...
│                       bvnr_conformance                            │
│                                                                   │
│  Test corpus (335 cases) ──→ for each test case:                │
│                                                                   │
...
| `units` | 41 | SI/IEC prefixes, compact prefix form, compound, inline, errors |
...
parent plan therefore counts the groups (currently 22), not the 335 cases.
