...
The registry covers 215 named units across SI {{SI}}, IEC binary
{{IEC80000-13}}, imperial and US customary, CGS, radiation, electrical
power, rotational, surveying, textile, and other families, accepting 646
...
| Form | Example | Notes |
|---|---|---|
| Superscript | `m²`, `m⁻³` | U+00B9, U+00B2, U+00B3, U+2074-U+2079; sign U+207A (no-op) or U+207B (negate) |
...
caret-exp     = "^" [ "+" / "-" ] %x31-39
sup-exp       = [ sup-sign ] sup-digit
sup-sign      = %xE2.81.BA / %xE2.81.BB     ; U+207A, U+207B
sup-digit     = %xC2.B9 / %xC2.B2 / %xC2.B3 ; U+00B9, U+00B2, U+00B3
