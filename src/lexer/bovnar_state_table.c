...
const uint8_t bvn_after_state_idx_table[dimension_state][256] = {
	...
	[sp_nan2] = { ['n'] = ACT_kw_advance },
	[sp_nan3] = { ['$'] = ACT_sp_nan_outro },
	[sp_inf1] = { ['n'] = ACT_kw_advance },
	[sp_inf2] = { ['f'] = ACT_kw_advance },
	[sp_inf3] = { ['i'] = ACT_kw_advance },
	[sp_inf4] = { ['n'] = ACT_kw_advance },
	[sp_inf5] = { ['i'] = ACT_kw_advance },
	[sp_inf6] = { ['t'] = ACT_kw_advance },
	[sp_inf7] = { ['y'] = ACT_kw_advance },
	[sp_inf8] = { ['$'] = ACT_sp_inf_outro },
	[sp_neg1] = { ['i'] = ACT_kw_advance },
	[sp_neg2] = { ['n'] = ACT_kw_advance },
	[sp_neg3] = { ['f'] = ACT_kw_advance },
	[sp_neg4] = { ['i'] = ACT_kw_advance },
	[sp_neg5] = { ['n'] = ACT_kw_advance },
	[sp_neg6] = { ['i'] = ACT_kw_advance },
	[sp_neg7] = { ['t'] = ACT_kw_advance },
	[sp_neg8] = { ['y'] = ACT_kw_advance },
	[sp_neg9] = { ['$'] = ACT_sp_neginf_outro },
	[symbol_body] = {
...
const state_t bvn_kw_advance_state[dimension_state] = {
	[sp_nan1] = sp_nan2,
	[sp_nan2] = sp_nan3,
	[sp_inf1] = sp_inf2,  [sp_inf2] = sp_inf3,  [sp_inf3] = sp_inf4,
	[sp_inf4] = sp_inf5,  [sp_inf5] = sp_inf6,  [sp_inf6] = sp_inf7,
	[sp_inf7] = sp_inf8,
	[sp_neg1] = sp_neg2,  [sp_neg2] = sp_neg3,  [sp_neg3] = sp_neg4,
	[sp_neg4] = sp_neg5,  [sp_neg5] = sp_neg6,  [sp_neg6] = sp_neg7,
	[sp_neg7] = sp_neg8,  [sp_neg8] = sp_neg9,
	[tf_ui]      = tf_uin,
	[tf_ut]      = tf_utf,
