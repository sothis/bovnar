...
#   160/163 non-currency base units reproduce bovnar's dimension AND magnitude
#   exactly (incl. 28 custom definitions + 6 affine temperature scales).
...
BASE_UNIT_TO_PINT: dict[int, str] = {
    ...
    # Mapped to pint native, but semantics differ — see SEMANTIC_CAVEATS
      2: 'byte',                         # BYTE
    102: 'neper',                        # NEPER
    103: 'decibel',                      # DECIBEL
