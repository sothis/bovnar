...
find . \( -type d \( -name .git -o -name build -o -name __pycache__ -o -name .cache -o -name .pytest_cache -o -name .github -o -name .claude -o -name pdf \) -o -name .gitignore \) -prune -o -print | zip -q9 build/merged/bovnar.zip -@
