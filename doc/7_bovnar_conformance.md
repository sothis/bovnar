...
│                       bvnr_conformance                            │
│                                                                   │
│  Test corpus (337 cases) ──→ for each test case:                │
│                                                                   │
...
| `units` | 43 | SI/IEC prefixes, compact prefix form, compound, inline, errors |
...
parent plan therefore counts the groups (currently 22), not the 337 cases.
