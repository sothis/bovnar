...
│                       bvnr_conformance                            │
│                                                                   │
│  Test corpus (341 cases) ──→ for each test case:                │
│                                                                   │
...
| `units` | 47 | SI/IEC prefixes, compact prefix form, compound, inline, errors |
...
parent plan therefore counts the groups (currently 22), not the 341 cases.
